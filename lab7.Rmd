...
# To Turn In
After you have everything configured, connect one of the tables from the new database to Domo and create a card. To complete the assignment, copy the url of the card as the submission of the lab.