...
To get started, [click here](https://aws.amazon.com/getting-started/tutorials/create-mysql-db/) and follow the instructions through step 3. (Feel free to go through step 4 after the course is completed, but only if you really feel like it.)
