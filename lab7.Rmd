...
* Select "Standard Create" and "MySQL" options ![DB Select](select_db.png)  
* Select "Free tier" in the Templates section (note you can select any option here, we won't need more than the free tier for this assignment). ![Templates](templates.png)  
...
* Create a password.
* Click the "additional connectivity configuration in the Connectivity section. ![Connectivity](connectivity.png)  
* Click "Yes" under Public access (not doing this will prevent you from finishing the assignment). ![public](public.png)  
...
* Go to the [accounts page in Domo](https://utah-is6481-fall2020.domo.com/datacenter/accounts) and share the account with Jeremy Morris (sharing can be done using the wrench in the appropriate account).
